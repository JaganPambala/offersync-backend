...
const whatsappCommunicationSchema = new mongoose.Schema({
    ...
    whatsapp: {
      ...
      templateUsed: {
        type: String,
        enum: ['DUPLICATE_OFFER', 'TIMELINE_SYNC', 'SALARY_DISCUSSION', 'CUSTOM'],
    ...
    outcome: {
      result: {
        type: String,
        enum: [
          'TIMELINE_AGREED', 'PRIORITY_SET', 'SALARY_ADJUSTED', 
          'CONFLICT_RESOLVED', 'NO_AGREEMENT', 'CANDIDATE_WITHDREW'
        ]
      },
      description: String,
      actions: [String],
